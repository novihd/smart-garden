...
class AirTemperaturePage extends StatefulWidget {
  const AirTemperaturePage({Key? key}) : super(key: key);

  @override
  State<AirTemperaturePage> createState() => _AirTemperaturePageState();
}

class _AirTemperaturePageState extends State<AirTemperaturePage> {
  String message = "";
  Timer? _timer;
          ...
          child: Column(
            ...
            children: [
                      ...
                      Align(
                          ...
                          child: Text(
                            _listDataModel.length == 0
                                ? "0°C"
                                : "${_listDataModel.last.airHum.toString()}°C",
                            style: TextStyle(
              ...
              Container(
                  ...
                  child: Text(
                      "Air Temperature: ${_listDataModel.length == 0 ? "0°C" : "${_listDataModel.last.airHum.toString()}°C"}",
                      style: TextStyle(
